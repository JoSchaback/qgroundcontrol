...
On Sequioa and late:
- After downloading the `dmg` file, open it an copy the QGC executable into you _Application_ folder by dragging the QGC exectuable into you _Application_ folder.
